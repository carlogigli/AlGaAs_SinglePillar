...
%
%
%% tracé courbe de dispersion du plasmon de Alex K reel
% retplot;n0=1;ld=.33;for K=linspace(100,1,100);ld=retcadilhac(@(ld) 1/n0^2+1./retindice(ld,1.8).^2-(2*pi./(ld*K)).^2,[],ld);eV=retdb(ld,'ld_2_eV');retplot(K,eV);end;
%
% See also: RETZP
...
if met==5;size(z)     % fonction non analytique
